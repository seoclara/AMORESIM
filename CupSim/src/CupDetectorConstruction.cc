...
//    density = 0.1786 * mg / cm3;
    ...
    G4Element *_elementCa_100 = new G4Element(name = "enriched Calsium", symbol = "Ca", nisotope = 1);
    _elementCa_100->AddIsotope(Ca40, abundance = 100. * perCent);
    ...
    CaMoO4->AddElement(_elementCa_100, 1);
