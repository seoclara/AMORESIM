...
G4double AmoreScintillation::TotalEnergyDepositQuenched = 0.0;

// Constructor /////////////////////////////////////////////////////////////
AmoreScintillation::AmoreScintillation(const G4String &processName, G4ProcessType type)
    : CupScintillation(processName, type) {}

// Destructor //////////////////////////////////////////////////////////////
AmoreScintillation::~AmoreScintillation() {}

// PostStepDoIt
// -------------
//
G4VParticleChange *AmoreScintillation::PostStepDoIt(const G4Track &aTrack, const G4Step &aStep)
...
// evenly along the track segment and uniformly into 4pi.
{
    ...
    if (scintillationByParticleType) {
        ...
        if (!Scint_Yield_Vector) {
            ...
            ed << "\nAmoreScintillation::PostStepDoIt(): "
            ...
            G4Exception("AmoreSim/AmoreScintillation::PostStepDoIt", "Scint01", FatalException, ed,
                        comments);
            return G4VRestDiscreteProcess::PostStepDoIt(aTrack, aStep);
        }
    ...
    if (verboseLevel > 1) {
        G4cout << "EJ: AmoreScintillation: edep= " << TotalEnergyDeposit
    ...
    if (verboseLevel > 0) {
        G4cout << "\n Exiting from AmoreScintillation::DoIt -- NumberOfSecondaries = "
